...
`r badge_github_actions("hruffieux/echoseq")` <!-- Run usethis::use_github_actions() to set up the pipeline, possibly modify the .yaml file and then: -->
`r badge_license("GPL v3")`
